...
var TbRow = function (_a) {
    ...
    var _b = (0, tubular_react_common_1.useMasterDetails)(), open = _b[0], openDetails = _b[1];
    ...
    return (React.createElement(React.Fragment, null,
        React.createElement(TableRow_1.default, { hover: true, onClick: onRowClick },
            detailComponent && (React.createElement(TableCell_1.default, { padding: "checkbox", size: "small", align: "center" },
                React.createElement(material_1.IconButton, { size: "small", onClick: openMasterDetails }, open ? React.createElement(KeyboardArrowDown_1.default, null) : React.createElement(KeyboardArrowRight_1.default, null)))),
            ...
            (0, renders_1.renderCells)(columns, row)),
        detailComponent && open && (React.createElement(TableRow_1.default, { hover: true },
            React.createElement(TableCell_1.default, { colSpan: columns.length + 1 },
                React.createElement(material_1.Collapse, { in: open, timeout: "auto", unmountOnExit: true },
