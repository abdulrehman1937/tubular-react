...
var renderCellContent = function (column, row) {
    ...
    switch (column.dataType) {
        ...
        case tubular_common_1.ColumnDataType.DateTimeUtc:
            var dateAsString = !value ? '' : (0, tubular_common_1.parseDateColumnValue)(column, value);
            return dateAsString;
...
var renderDefaultListItem = function (columns, row) {
    return columns
        ...
        .map(function (column) { return React.createElement("div", { key: column.name }, (0, exports.renderCellContent)(column, row)); });
};
exports.renderDefaultListItem = renderDefaultListItem;
var renderCells = function (columns, row) {
    return columns
        .filter(function (col) { return col.visible; })
        .map(function (column) { return (React.createElement(TableCell_1.default, { key: column.name, padding: column.label === '' ? 'none' : 'normal', align: (0, tubular_common_1.getColumnAlign)(column) }, (0, exports.renderCellContent)(column, row))); });
};
