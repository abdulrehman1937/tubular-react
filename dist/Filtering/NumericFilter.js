...
var NumericFilter = function (_a) {
    ...
    return (React.createElement(Grid_1.default, { container: true, direction: "column" },
        React.createElement(Grid_1.default, { item: true },
            React.createElement(TextField_1.default, { label: '', type: "number", placeholder: isBetween ? 'From' : 'Type a number', onChange: handleFilterChange(), defaultValue: column.filterText, onKeyDown: (0, utils_1.onKeyDown)(onApply) })),
        isBetween && (React.createElement(Grid_1.default, { item: true },
            React.createElement(TextField_1.default, { label: '', type: "number", placeholder: "To", onChange: handleFilterChange(true), defaultValue: column.filterArgument ? column.filterArgument[0] : '', onKeyDown: (0, utils_1.onKeyDown)(onApply) })))));
};
