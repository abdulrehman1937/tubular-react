...
var DateFilter = function (_a) {
    ...
    var _b = React.useState(getInitialDates(column)),
        dates = _b[0],
        setDates = _b[1];
    var handleDateChange = function (isSecondInput) {
            ...
            React.createElement(
                ...
                React.createElement(DatePicker_1.default, {
                    ...
                    renderInput: function (props) {
                        return React.createElement(core_1.TextField, __assign({}, props));
                    },
                }),
            ),
            column.filterOperator === tubular_common_1.CompareOperators.Between &&
                React.createElement(
                    Grid_1.default,
                    { item: true },
                    React.createElement(DatePicker_1.default, {
