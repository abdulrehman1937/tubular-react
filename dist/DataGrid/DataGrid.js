...
var DataGrid = function (props) {
    ...
    var tbTableInstance = (0, tubular_react_common_1.useTbTable)(columns, dataSource, {
    ...
    var isMobileResolution = (0, uno_react_1.useResolutionSwitch)(mobileBreakpointWidth, timeout)[0];
    var selection = (0, useTbSelection_1.useTbSelection)(tbTableInstance, rowSelectionEnabled);
