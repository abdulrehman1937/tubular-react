...
var TbListItem = function (_a) {
    ...
    return (React.createElement(ListItem_1.default, { button: true, selected: selectedIndex === 0, onClick: onItemClick, style: __assign(__assign({}, rowStyle), { padding: '20px' }) }, (0, renders_1.renderDefaultListItem)(columns, row)));
};
