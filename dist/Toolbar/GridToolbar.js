...
var GridToolbar = function (_a) {
    ...
    var isMobileResolution = (0, uno_react_1.useResolutionSwitch)(outerWidth, timeout)[0];
    var applyFilters = function (columns) {
        columns.forEach(function (fColumn) {
            ...
            if ((0, tubular_common_1.columnHasFilter)(fColumn)) {
    ...
    var _b = (0, uno_react_1.useToggle)(false), isPanelOpen = _b[0], togglePanel = _b[1];
